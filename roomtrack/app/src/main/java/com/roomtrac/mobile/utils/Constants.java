...
public class Constants {
    ...
    public static final int RT_LOGIN=400;
    public static final int RT_SEARCH=401;
    public static final int RT_SEARCH_HOSTEL=402;
    public static final int RT_SEARCH_LOCATION=403;
    public static final int RT_COUNTRIES=404;
    public static final int RT_STATE=405;
    public static final int RT_CITYE=406;
    public static final int RT_LOCATION=407;
    public static final int RT_HOME_PREF=408;
    public static final int RT_ROOM_TYPE=409;
    ...
    public static final int MYACCOUNT=306;
    public static final int ACCOUNTSETTINGS=307;
