...
public class ViewHolder {
    ...
    public CustomEditText multiline_text,singleline_text,comment__ad_ed,skill_title_value,skill_comment_value,skill_level_edit,mJobtitle_edit,mRequester_edit;
    public TextInputLayout skill_comment_text,comment_ad;
    public CustomTextView applicant_header_text,applicant_qation,skill_title,slider_item,resume_title,skill_exp_text,skill_level_text,mFromdate_lbl,mTodate_lbl,mJobTitle_lbl,mRecutur_lbl;
    ...
    public CustomEditText skill_exp_edit,skill_title_edit;
