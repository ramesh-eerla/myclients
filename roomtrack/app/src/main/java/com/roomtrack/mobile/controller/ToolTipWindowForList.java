...
private int align;
	...
	public ToolTipWindowForList(Context context, String text, int viewResource) {
		mContext = context;
	...
	public ToolTipWindowForList(Context context) {
		this(context, "", R.layout.popup);
	}

	public ToolTipWindowForList(Context context, String text) {
		this(context);
		
		setText(text,align);
	}
	public ToolTipWindowForList(Context context, int align,String text) {
		this(context);
		this.align=align;
		setText(text,align);
	}
	...
	public void setText(String text, int align2) {
		Spanned sd = Html.fromHtml(text.trim());
		mHelpTextView.setText(sd);
		if(align2==1)
